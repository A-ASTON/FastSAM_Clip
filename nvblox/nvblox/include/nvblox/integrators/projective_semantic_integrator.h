...
///
/// Integrates semantic images into semantic layers. The "projective" describes
...
class ProjectiveSemanticIntegrator {
 public:
  struct SemanticConfig {
    ...
    std::shared_ptr<SemanticLabel2Color> semantic_color_tool_ = nullptr;
    std::string filename;
  ...
  /// Configuration
  SemanticConfig semantic_config_; // 语义分割相关
  ...
  void setSemanticProbabilities(); //设置对数似然函数

  /// Integrates a semantic image into the passed semantic layer.
  /// @param semantic_frame A 2d segment image.
