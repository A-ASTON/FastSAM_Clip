...
// 测试宏函数 (测试用例名是一个继承自::testing::Test的类， 测试名)
// 测试ProjectiveColorIntegrator 的getter和setter是否有用
...
TEST_F(ColorIntegrationTest, IntegrateColorToGroundTruthDistanceField) {
  ...
  // Color layer
  ColorLayer color_layer(voxel_size_m_, MemoryType::kDevice);// Layer
...
int main(int argc, char** argv) {
  ...
  FLAGS_nvblox_test_file_output = true;
